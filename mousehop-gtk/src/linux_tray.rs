...
fn render_tray_pixmaps() -> Vec<Icon> {
    ...
    // resources/icons/mousehop-tray.svg. Tight viewBox + simple
...
pub(crate) fn setup(app: &adw::Application, window: &Window) -> gio::ApplicationHoldGuard {
    ...
    let service = TrayService::new(MousehopTray {
        tx,
        last_toggle: None,
        icon_pixmaps,
    });

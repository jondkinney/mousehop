...
impl Window {
    ...
    fn setup_icon(&self) {
        self.set_icon_name(Some("com.mousehop.Mousehop"));
    }
    ...
    pub(super) fn set_running_apps(&self, apps: Vec<mousehop_ipc::RunningApp>) {
    ...
    pub(super) fn set_authorized_keys(
        &self,
        mut fingerprints: HashMap<String, mousehop_ipc::IncomingPeerConfig>,
    ) {

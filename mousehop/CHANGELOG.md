...
## [0.17.1](https://github.com/jondkinney/mousehop/compare/v0.17.0...v0.17.1) - 2026-09-05

### Fixed

- *(layer-shell)* place fallback returns at the current display edge

## [0.17.0](https://github.com/jondkinney/mousehop/compare/v0.16.0...v0.17.0) - 2026-09-02
...
- *(macos)* prevent screen saver during outgoing capture

## [0.15.5](https://github.com/jondkinney/mousehop/compare/v0.15.4...v0.15.5) - 2026-08-25

### Fixed

- *(emulation/wlroots)* release keymap subscription
...
- release a stale capture when capture is re-enabled
- *(linux)* always tear down the pointer lock in ungrab

## [0.15.1](https://github.com/jondkinney/mousehop/compare/v0.15.0...v0.15.1) - 2026-08-15

### Fixed

- *(emulation/macos)* warp to the right monitor
- *(emulation/windows)* warp to the right monitor
